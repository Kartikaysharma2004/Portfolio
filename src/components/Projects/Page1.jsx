...
const Page1 = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      liveLink: "https://shkw-dev.vercel.app/",
      codeLink: "https://github.com/Kartikaysharma2004/shkw-dev",
    },
    {
      id: 3,
      image: "src/images/react-projects.png",
    ...
    },
    {
      ...
      title: "JavScript Projects",
      description:
        "This collection showcases a variety of JavaScript projects that I've developed to demonstrate my skills and creativity in web development.",
      codeLink: "https://github.com/Kartikaysharma2004/JavaScript-Projects",
      liveLink: "https://myjsworks.netlify.app/",
    },
  ];
    ...
    <>
      <section ref={projectRef} id="mywork" class="mywork py-16 max-md:px-4 px-16">
        ...
        <div className="flex justify-center pt-5">
          <a href="https://github.com/Kartikaysharma2004/" target="_blank">
            <button
              type="button"
