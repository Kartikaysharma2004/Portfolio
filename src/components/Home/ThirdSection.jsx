    ...
    <section className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          {/* LATEST ROLES */}
          <div className="about-container bg-[#eef0ff] rounded-3xl p-8 text-black">
            <h3 className="font-semibold mb-6">Latest Roles</h3>
                ...
                <div key={item.id}>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center justify-between w-full">
                      ...
                      <h3 className="text-sm max-sm:text-xs text-[#838C96] whitespace-nowrap">{item.timeline}</h3>
                    </div>
                  </div>

                  {/* Divider except last item */}
                  {index !== roles.length - 1 && (
                    <hr className="border border-[#e2e8f0] mt-4" />
                  )}
                </div>
              ))}
            </div>
