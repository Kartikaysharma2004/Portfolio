    ...
    <section ref={educationRef} className="w-full my-16 px-4 py-16">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between">
        ...
        <div ref={textRef} className="md:w-1/2">
          <h2 className="text-lg mb-2 text-[#30AF5B]"><FontAwesomeIcon icon={faStarOfLife} className="text-lg mr-2" /><ShinyText text="Experience" speed={2.8} color='#30AF5B' shineColor='#b5ff6d' />
          </h2>
        ...
        {/* LATEST ROLES */}
          <div className="about-container rounded-3xl max-sm:py-8 max-sm:px-4 text-black">
